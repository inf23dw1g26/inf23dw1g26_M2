...
insert into volunteer (idVolunteer, name, anoInicioVolunteering, phoneNumber, address) values (15, 'Mello', 2023, 9368521882, 'Avenida Conde Castro Guimaraes 12-B')
...
insert into volunteer (idVolunteer, name, anoInicioVolunteering, phoneNumber, address) values (20, 'Júlio', 2019, 938521978, 'Praca 25 de Abril 17')
...
insert into volunteer (idVolunteer, name, anoInicioVolunteering, phoneNumber, address) values (22, 'Júlia', 2020, 938521438, 'Rua Antonio Palha')
...
insert into volunteer (idVolunteer, name, anoInicioVolunteering, phoneNumber, address) values (28, 'Flávia', 2022, 968521666, 'Rua Vieira da Silva 9')
...
insert into person (idPerson, name, address) values (8, 'Lourenço', 'Avenida Adriano Julio Coelho 7')
insert into person (idPerson, name, address) values (9, 'Kimberly', 'Rua Dona Maria')
insert into person (idPerson, name, address) values (10, 'Mário', 'Rua Guilherme Gomes Fernandes 41')
insert into person (idPerson, name, address) values (11, 'Fabio', 'Rua Brasília')
...
insert into person (idPerson, name, address) values (19, 'Natália', 'Praceta Calouste Gulbenkian 6')
...
insert into person (idPerson, name, address) values (26, 'Luís', 'Avenida Professor Doutor Augusto Abreu Lopes')
...
insert into person (idPerson, name, address) values (29, 'Tomás', 'Rua Alto')
...
insert into animal(idAnimal, name, age, typeAnimal, breed, description) values (2, 'Chewy', 3, 'Hamster', 'Winter White Russian Dwarf')
...
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (1, 1, 'Adoption 01', 'Rua Doutor Miguel Bombarda 247', 30,'The animal of this adoption was a dog named Bobi')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (2, 2, 'Adoption 02', 'Rua Alto', 29, 'The animal of this adoption was a hamster named Chewy')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (3, 3, 'Adoption 03', 'Rua Arnaldo Jesus Gomes', 28, 'The animal of this adoption was a dog named Bambi')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (4, 4, 'Adoption 04',  'Avenida General Barnabe Antonio Ferreira 215', 27, 'The animal of this adoption was a hamster named Angel')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (5, 5, 'Adoption 05',  'Avenida Professor Doutor Augusto Abreu Lopes', 26, 'The animal of this adoption was a rabbit named Lilly')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (6, 6, 'Adoption 06',  'Rua Antonio dos Reis 171', 25, 'The animal of this adoption was a dog named Fluffy')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (7, 7, 'Adoption 07',  'Rua Jeronimo Rodrigues Vilarinho', 24, 'The animal of this adoption was a cat named Cuddles')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (8, 8, 'Adoption 08',  'Alameda Combatentes da Grande Guerra 12-A', 23, 'The animal of this adoption was a cat named Duke')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (9, 9, 'Adoption 09',  'Estr. Nacional 249/1 Venteira', 22, 'The animal of this adoption was a rabbit named Chibi')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (10, 10, 'Adoption 10',  'Rua 4 de Outubro, n.o 19', 21, 'The animal of this adoption was a dog named Sunshine')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (11, 11, 'Adoption 11',  'Rua da Praia da Adraga 63', 20, 'The animal of this adoption was a cat named Nibbles')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (12, 12, 'Adoption 12',  'Praceta Calouste Gulbenkian 6', 19, 'The animal of this adoption was a dog named Kooky')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (13, 13, 'Adoption 13',  'Avenida Alexandre Salles', 18, 'The animal of this adoption was a cat named Mizuki')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (14, 14, 'Adoption 14',  'Rua Manuel Arriaga 64', 17, 'The animal of this adoption was a hamster named Taz')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (15, 15, 'Adoption 15',  'Rua Professor Doutor Alfredo da Costa 108', 16, 'The animal of this adoption was a dog named Lucy')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (16, 16, 'Adoption 16',  'Rua Combatentes do Ultramar 71', 15, 'The animal of this adoption was a rabbit named Sprinkle')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (17, 17, 'Adoption 17',  'Rua Luis de Camoes 2', 14, 'The animal of this adoption was a dog named Dino')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (18, 18, 'Adoption 18',  'Estrada Marques de Pombal 51', 13, 'The animal of this adoption was a dog named Mondo')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (19, 19, 'Adoption 19',  'Rua Professor Agostinho da Silva 8', 12, 'The animal of this adoption was a cat named Muffins')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (20, 20, 'Adoption 20',  'Rua Brasília', 11, 'The animal of this adoption was a cat named Calico')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (21, 21, 'Adoption 21',  'Rua Guilherme Gomes Fernandes 41', 10, 'The animal of this adoption was a rabbit named Polka')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (22, 22, 'Adoption 22',  'Rua Dona Maria', 9, 'The animal of this adoption was a hamster named Sparkle')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (23, 23, 'Adoption 23',  'Avenida Adriano Julio Coelho 7', 8, 'The animal of this adoption was a dog named Binky')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (24, 24, 'Adoption 24',  'Rua Doutor Joao Gomes Patacao 21', 7, 'The animal of this adoption was a cat named Ivy')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (25, 25, 'Adoption 25',  'Rua Oliveira Martins 3', 6, 'The animal of this adoption was a cat named Mittens')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (26, 26, 'Adoption 26',  'Rua 29 de Setembro', 5, 'The animal of this adoption was a dog named Scarlett')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (27, 27, 'Adoption 27',  'Rua Ivens', 4, 'The animal of this adoption was a cat named Sissy')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (28, 28, 'Adoption 28',  'Rua Clube de Tenis', 3, 'The animal of this adoption was a dog named Kane')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (29, 29, 'Adoption 29',  'Rua das flores 51', 2, 'The animal of this adoption was a cat named Kirby')
insert into adoption (idAdoption, idAnimal, name, address, idPerson, idVolunteer, description) values (30, 30, 'Adoption 30',  'Rua das arvores', 1, 'The animal of this adoption was a dog named Lassie')
